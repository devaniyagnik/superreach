    ...
    <footer>
      <div className={"container"}>
        ...
        <div className={"row bottomFooter px-3 pb-5 px-md-0 py-md-3 g-0"}>
          ...
          <div className={"col-12 col-sm-6 col-md-4 col-lg-2 mt-4 order-lg-2"}>
            <h2>Explore</h2>
          ...
          <div className={"col-12 col-sm-6 col-md-4 col-lg-2 mt-4 order-lg-3"}>
          ...
          <div className={"col-12 col-sm-6 col-md-4 col-lg-2 mt-4 order-lg-4"}>
            <h2>Features</h2>
            <ul className={"m-0 p-0"}>
              <li>
                <a href={"#"}>Outreach</a>
          ...
          <div className={"col-12 col-sm-6 col-md-4 col-lg-2 mt-4 order-lg-5"}>
            <h2>Resources</h2>
            <ul className={"m-0 p-0"}>
              <li>
                <a href={"#"}>Help desk</a>
