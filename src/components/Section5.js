  ...
  return (
    <>
      ...
      <section className="section5 py-5 px-3">
        <div className="container">
          <div className="row px-md-0">
            <div className="col-12 col-md-6 section5-left section5-left-men">
            ...
            <div className="col-12 col-md-6 section5-right ">
              ...
              <p>
                <span className="bullet">&#8226;</span> Role-play with 100’s of
                Customer Avatars
              </p>
              <p>
                <span className="bullet">&#8226;</span> Automated Coaching
              </p>
              <p>
                <span className="bullet">&#8226;</span> Find out who can sell within
                a week. (fail fast)
              </p>
      ...
      <section className="section5 px-3">
        <div className="container">
          <div className="row px-md-0">
            <div className="col-12 col-md-6 order-md-1 order-2 section5-right">
              <h4>Find. Engage. Automate</h4>
              <hr className="hrlineheader" />
              <h2>AI Sales Training</h2>
              <p>
                Develop sales skills rapidly and get a year of sales experience
                in just 14 days
              </p>
              <p>
                <span className="bullet">&#8226;</span> Role-play with 100’s of
            ...
            <div className="col-12 col-md-6 section5-left  order-md-2 order-1 section5-left-women px-1">
              <div className="row boxofimg">
                <div className="col-3 justify-content-start">
                  <span className="quotes">“</span>
                </div>
